...
export default function Navbar() {
  return (
    <Disclosure
      as="nav"
      className="bg-black w-full fixed top-0 z-50 opacity-70"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative flex h-20 items-center justify-between">
          ...
          <div className="flex items-center">
            <Button
              variant="secondary"
              className="text-md text-white bg-[#A5801F] hover:bg-[#a57f1fc2] sm:text-lg sm:tracking-widest cursor-pointer"
            >
              Call Us: 9811799850
            </Button>
          </div>
      ...
      <DisclosurePanel className="sm:hidden absolute top-20 left-0 w-full bg-black z-50">
